    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-100 flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 border border-green-100">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[#008000]">Forgot Password</h1>
        ...
        {success && (
          <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3">
            ...
            <div>
              <p className="text-[#008000] font-semibold">Email Sent!</p>
              <p className="text-green-700 text-sm mt-1">Check your email for password reset instructions.</p>
            </div>
          </div>
        )}
